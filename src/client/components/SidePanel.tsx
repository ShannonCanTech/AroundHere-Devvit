...
export const SidePanel: React.FC<SidePanelProps> = ({ isOpen, onClose, username, isConnected }) => {
  return (
    <>
      {/* Backdrop */}
      {isOpen && (
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <h3 className="text-sm font-semibold text-gray-500 uppercase mb-2">User Info</h3>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800 font-medium">{username || 'Anonymous'}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div
                    className={cn(
            ...
            {/* Menu Options */}
            <div className="space-y-2">
              <button className="w-full text-left p-4 hover:bg-gray-50 rounded-lg transition-colors flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
