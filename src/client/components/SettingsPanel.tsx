        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="p-4 border-b border-gray-200">
              ...
              <div className="space-y-2">
                <div className="p-4 rounded-lg bg-gray-50">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#d93900] rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#d93900]"></div>
                    </label>
                  </div>
                  <p className="text-xs text-gray-500 ml-8">Receive notifications for new messages</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gray-50">
                  ...
                  <p className="text-xs text-gray-500 ml-8">Enable dark theme</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gray-50">
                  ...
                  <p className="text-xs text-gray-500 ml-8">Play sounds for messages and notifications</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              ...
              <button className="w-full text-left p-4 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-3 border border-red-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
